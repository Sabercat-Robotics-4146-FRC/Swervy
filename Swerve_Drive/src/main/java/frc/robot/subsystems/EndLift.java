...
public class EndLift implements Subsystem {
    private final CANSparkMax liftMotorLeader = new CANSparkMax(LiftMotorLeader, MotorType.kBrushless);
    private final CANSparkMax liftMotorFollower = new CANSparkMax(LiftMotorFollower, MotorType.kBrushless);
